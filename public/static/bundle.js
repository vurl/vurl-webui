...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	function copy_value_binding(value) {
    		/*copy_value_binding*/ ctx[12].call(null, value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 68, 6, 1448);
    			attr_dev(h2, "class", "svelte-eqw36");
    			add_location(h2, file$2, 67, 4, 1437);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(67:2) {#if shorturlcomplete}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 75, 2, 1617);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:2) {#if validationerror}",
    		ctx
    	});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				...
    				listen_dev(input, "click", /*selectinputtext*/ ctx[7], false, false, false),
    				listen_dev(button, "click", /*geturl*/ ctx[8], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("selectinputtext" in $$props) $$invalidate(7, selectinputtext = $$props.selectinputtext);
    		if ("geturl" in $$props) $$invalidate(8, geturl = $$props.geturl);
