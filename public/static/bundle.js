...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-1h45r81");
    			add_location(textarea, file, 33, 2, 629);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			t2 = text(/*copytext*/ ctx[2]);
    			attr_dev(path, "fill-rule", "evenodd");
    			attr_dev(path, "fill", "#AB61B7");
    			attr_dev(path, "d", "M2 13h4v1H2v-1zm5-6H2v1h5V7zm2 3V8l-3 3 3 3v-2h5v-2H9zM4.5 9H2v1h2.5V9zM2 12h2.5v-1H2v1zm9 1h1v2c-.02.28-.11.52-.3.7-.19.18-.42.28-.7.3H1c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c0-1.11.89-2 2-2 1.11 0 2 .89 2 2h3c.55 0 1 .45 1 1v5h-1V6H1v9h10v-2zM2 5h8c0-.55-.45-1-1-1H8c-.55 0-1-.45-1-1s-.45-1-1-1-1 .45-1 1-.45 1-1 1H3c-.55 0-1 .45-1 1z");
    			add_location(path, file, 45, 2, 893);
    			attr_dev(svg, "title", "Copy to clipboard");
    			attr_dev(svg, "class", "octicon octicon-clippy svelte-1h45r81");
    			attr_dev(svg, "viewBox", "0 0 14 16");
    			attr_dev(svg, "version", "1.1");
    			attr_dev(svg, "width", "14");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "aria-hidden", "true");
    			add_location(svg, file, 36, 0, 715);
    			attr_dev(button, "class", "svelte-1h45r81");
    			add_location(button, file, 35, 0, 690);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = listen_dev(button, "click", /*copy*/ ctx[3], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*copytext*/ 4) set_data_dev(t2, /*copytext*/ ctx[2]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function copy() {
    		...
    		try {
    			...
    			if (!successful) {
    				...
    				$$invalidate(2, copytext = "DONE");
    				clearTimeout(timer);

    				timer = setTimeout(
    					() => {
    						$$invalidate(2, copytext = "Copy");
    					},
    					2000
    				);
    			}
    	...
    	return [valueCopy, areaDom, copytext, copy, value, timer, textarea_binding];
    }

    class Copy extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { value: 4 });
    ...
    function create_if_block_3(ctx) {
    	...
    	let if_block0 = /*pastemode*/ ctx[5] && create_if_block_5(ctx);
    	let if_block1 = !/*pastemode*/ ctx[5] && create_if_block_4(ctx);
    ...
    // (124:4) {#if urlsanitizedvisibility}
    function create_if_block_2(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text(/*urlsanitized*/ ctx[6]);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*urlsanitized*/ 64) set_data_dev(t, /*urlsanitized*/ ctx[6]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(124:4) {#if urlsanitizedvisibility}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(130:4) {#if validationerror}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	function copy_value_binding(value) {
    		/*copy_value_binding*/ ctx[18].call(null, value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-2hbrex");
    			add_location(a, file$2, 136, 6, 2736);
    			attr_dev(h2, "class", "svelte-2hbrex");
    			add_location(h2, file$2, 135, 4, 2725);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(135:2) {#if shorturlcomplete}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let current;
    	let dispose;
    	let if_block0 = /*loading*/ ctx[4] && create_if_block_6(ctx);
    	let if_block1 = !/*loading*/ ctx[4] && create_if_block_3(ctx);
    	let if_block2 = /*urlsanitizedvisibility*/ ctx[7] && create_if_block_2(ctx);
    	let if_block3 = /*validationerror*/ ctx[2] && create_if_block_1(ctx);
    	let if_block4 = /*shorturlcomplete*/ ctx[1] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t8 = text("Made for you by Open Source community with ");
    			img1 = element("img");
    			t9 = space();
    			ul = element("ul");
    			li0 = element("li");
    			...
    			a1 = element("a");
    			a1.textContent = "CLI";
    			attr_dev(img0, "class", "brand svelte-2hbrex");
    			if (img0.src !== (img0_src_value = "/static/vurl-logo.png")) attr_dev(img0, "src", img0_src_value);
    			add_location(img0, file$2, 88, 2, 1851);
    			add_location(br, file$2, 91, 2, 1911);
    			input.required = true;
    			attr_dev(input, "placeholder", "Enter your long URL");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "svelte-2hbrex");
    			add_location(input, file$2, 93, 2, 1945);
    			attr_dev(button, "class", "svelte-2hbrex");
    			add_location(button, file$2, 102, 2, 2145);
    			attr_dev(p0, "class", "sanitizedurl svelte-2hbrex");
    			add_location(p0, file$2, 122, 2, 2459);
    			attr_dev(div0, "class", "container svelte-2hbrex");
    			add_location(div0, file$2, 92, 2, 1919);
    			attr_dev(p1, "class", "error svelte-2hbrex");
    			add_location(p1, file$2, 128, 2, 2570);
    			attr_dev(div1, "class", "container resultplot svelte-2hbrex");
    			add_location(div1, file$2, 133, 2, 2661);
    			attr_dev(img1, "width", "10");
    			if (img1.src !== (img1_src_value = "/static/heart.svg")) attr_dev(img1, "src", img1_src_value);
    			add_location(img1, file$2, 145, 46, 2971);
    			attr_dev(span, "class", "lovetext svelte-2hbrex");
    			add_location(span, file$2, 144, 4, 2901);
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "href", "https://github.com/vurl");
    			attr_dev(a0, "class", "svelte-2hbrex");
    			add_location(a0, file$2, 149, 9, 3048);
    			attr_dev(li0, "class", "svelte-2hbrex");
    			add_location(li0, file$2, 148, 3, 3034);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", "https://github.com/vurl/vurl-cli");
    			attr_dev(a1, "class", "svelte-2hbrex");
    			add_location(a1, file$2, 154, 9, 3147);
    			attr_dev(li1, "class", "svelte-2hbrex");
    			add_location(li1, file$2, 153, 3, 3133);
    			attr_dev(ul, "class", "svelte-2hbrex");
    			add_location(ul, file$2, 147, 4, 3026);
    			attr_dev(footer, "class", "svelte-2hbrex");
    			add_location(footer, file$2, 143, 2, 2888);
    			attr_dev(main, "class", "svelte-2hbrex");
    			add_location(main, file$2, 87, 0, 1842);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				...
    				listen_dev(input, "input", /*onchange*/ ctx[9], false, false, false),
    				listen_dev(input, "keydown", /*onenter*/ ctx[8], false, false, false),
    				listen_dev(input, "click", /*selectinputtext*/ ctx[10], false, false, false),
    				listen_dev(input, "paste", /*onpaste*/ ctx[11], false, false, false),
    				listen_dev(button, "click", /*geturl*/ ctx[12], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*urlsanitizedvisibility*/ ctx[7]) {
    				if (if_block2) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let onchange = e => {
    		setTimeout(
    			() => {
    				if (url === "") {
    					$$invalidate(5, pastemode = true);
    				} else {
    					$$invalidate(5, pastemode = false);
    				}
    			},
    			0
    		);
    	...
    	async function paste(input) {
    		$$invalidate(0, url = await navigator.clipboard.readText());
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("pastemode" in $$props) $$invalidate(5, pastemode = $$props.pastemode);
    		if ("onenter" in $$props) $$invalidate(8, onenter = $$props.onenter);
    		if ("onchange" in $$props) $$invalidate(9, onchange = $$props.onchange);
    		if ("selectinputtext" in $$props) $$invalidate(10, selectinputtext = $$props.selectinputtext);
    		if ("onpaste" in $$props) $$invalidate(11, onpaste = $$props.onpaste);
    		if ("geturl" in $$props) $$invalidate(12, geturl = $$props.geturl);
    		if ("fetchurl" in $$props) fetchurl = $$props.fetchurl;
    		if ("urlsanitized" in $$props) $$invalidate(6, urlsanitized = $$props.urlsanitized);
    		if ("urlsanitizedvisibility" in $$props) $$invalidate(7, urlsanitizedvisibility = $$props.urlsanitizedvisibility);
    	};

    	let urlsanitized;
    	let urlsanitizedvisibility;

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*url*/ 1) {
    			 $$invalidate(6, urlsanitized = decodeURI(url).slice(0, 100));
    		}

    		if ($$self.$$.dirty & /*url*/ 1) {
    			 $$invalidate(7, urlsanitizedvisibility = decodeURI(url) !== url);
    		}
    	};
